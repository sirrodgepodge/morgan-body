...
*Note: console output is colorized for iTerm2, might look odd on terminals with other background colors, which can be solved by [Themes](https://github.com/sirrodgepodge/morgan-body#available-themes)
